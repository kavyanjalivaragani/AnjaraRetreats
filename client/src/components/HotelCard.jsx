...
const HotelCard = ({ room, index }) => {
    // Safety check: if room doesn't exist at all, return nothing
    if (!room) return null;
    ...
    return (
        ...
        >
            {/* Added optional chaining for images array */}
            <img src={room.images?.[0] || assets.placeholderImage} alt={room.hotel?.name || "Room"} />
            ...
            <div className='p-4 pt-5'>
                <div className='flex items-center justify-between'>
                    <p className='font-playfair text-xl font-medium text-gray-800'>
                        {/* FIXED: Added optional chaining here to prevent crash */}
