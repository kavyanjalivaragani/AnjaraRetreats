...
//check if room is available
  ...
  //onsubmitter function to check availability&book room
  ...
  return room && (
    <div className='py-28 md:py-36 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      <form onSubmit={onSubmitHandler} className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
        ...
        <button
          type="submit"
          className='bg-orange-500 hover:bg-orange-600 active:scale-95 transition-all text-white rounded-md max-md:w-full max-md:mt-6 px-10 py-3 md:py-4 text-base cursor-pointer'
        >
      ...
      <div className='max-w-3xl border-y border-gray-300 my-16 py-10 text-gray-500'>
        <p>
          Step into a world where elegance meets effortless comfort. Our hotel is
          designed for travelers who value refined spaces, thoughtful details,
...
<div className='flex flex-col items-start gap-4'>
  ...
  <button className='px-6 py-2.5 mt-4 rounded text-white bg-orange-500
